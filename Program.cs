...
namespace GraMonolitycznie
{
    class Program
    {
        ...
        /// 
        /// </summary>
        /// <param name="a">dowolona liczba</param>
        ...
        static int WczytajLiczbe(string prompt = " Podaj liczbe ( lub X aby zakonczyc ): ")
        {
            int propozycja = 0;
            while (true)
            { 
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Wylosowałem liczbę od {min} do {max}. Odgadnij ją");
            ...
            do
            {
                ...
                try
                {
                     propozycja = WczytajLiczbe("Podaj swoją propozycje lub X: ");
                }
